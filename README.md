...
> 2025년 2월 출시. 별도 광고 없이 자연 유입만으로 달성한 수치입니다.

| 날짜 | 방문자 | 페이지뷰 | 바운스율 |
|------|--------|----------|----------|
| 1일차 (2/9) | 9명 | 15 | 56% |
| 2일차 (2/10) | 98명 | 202 | 69% |
| 3일차 (2/11) | 173명 | 801 | **25%** |
| 4일차 (2/12) | 209명 | 938 | 32% |
| 4/20 | 8명 | 28 | 12% |

**3일차 주목:** 바운스율 25%, 세션당 평균 페이지뷰 4.6 — 단순 방문이 아니라 실제로 여러 판을 플레이한 유저가 대다수였습니다.

📅 출시 2개월 이후에도 별도 홍보 없이 하루 약 10명의 유저가 자발적으로 재방문 중입니다.
